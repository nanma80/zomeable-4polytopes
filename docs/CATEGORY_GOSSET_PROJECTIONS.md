...
| E6 root polytope (`1_22`) | 6 | 2 | [3D viewer ->](https://nanma80.github.io/zomeable-4polytopes/output/gosset_projections/VIEWER.html#1_22) |
...
All 15 labelled models are available in a flat folder:
...
Eleven models have full B3/octahedral point-cloud symmetry; one 5-demicube
...
methodology finds three models and saturates already at R=1.  For the E6 root
polytope (`1_22`), the same methodology finds two models and saturates through
R=3.
