...
Gosset polytopes `2_21`, `3_21`, and `4_21`, whose natural dimensions are 6,
7, and 8.  The `1_21` member (the 5-demicube) is also included as the next
lower member of the same Gosset chain.

| Source polytope | Natural dimension | Models | Viewer |
|---|---:|---:|---|
| `1_21` | 5 | 3 | [3D viewer ->](https://nanma80.github.io/zomeable-4polytopes/output/gosset_projections/VIEWER.html#1_21) |
...
All 13 labelled models are available in a flat folder:
...
Nine models have full B3/octahedral point-cloud symmetry; one `1_21` model has
full D4/tetragonal point-cloud symmetry; the two `3_21` N=44 models and the
`4_21` N=137 model have full H3/icosahedral symmetry.
...
found no additional distinct models.  For `1_21`, the same methodology finds
three models and saturates already at R=1.
