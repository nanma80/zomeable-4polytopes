...
| 7-demicube (`1_41`) | 7 | 6 | [3D viewer ->](https://nanma80.github.io/zomeable-4polytopes/output/gosset_projections/1_41.html) |
...
All 52 labelled models are available in this folder tree:
...
Thirty-two models have full B3/octahedral point-cloud symmetry; five models have
full D4/tetragonal point-cloud symmetry; three models have full
...
H3/icosahedral symmetry, as does the `1_41` N=64 model.
...
sweep finds six models and saturates through R=3.  For `1_22`, the
