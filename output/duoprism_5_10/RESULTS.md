...
|---|------|-------------------|--------:|--------|
| 1 | `face_first_decagon_04.vZome` | face_first / decagon | 50 | B:50  R:50 |
...
➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/duoprism_5_10/RESULTS.html)** to interact with the 3D models below (the embeds only render when this file is served via GitHub Pages, not in github.com's markdown preview).
