...
- Folder: `output/cantellated_120cell/`
...
➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/cantellated_120cell/RESULTS.html)** to interact with the 3D models below (the embeds only render when this file is served via GitHub Pages, not in github.com's markdown preview).
...
<figure style="width: 800px; margin: 5%">
 <vzome-viewer style="width: 100%; height: 500px" src="cantellated_120cell_cell_first_rhombicosidodecahedron.vZome" progress="true" >
 </vzome-viewer>
