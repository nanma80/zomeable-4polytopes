# runcinated tesseract → zomeable orthographic projections

- Coxeter group: **B4**, Wythoff bitmask: **(1,0,0,1)**
- Vertices: **64**, edges: **192**
- Folder: `output/runcinated_8cell/`
...
- Manifest entry: `output/wythoff_sweep_manifest.json` (search `"source_polytope": "runcinated tesseract"`).
