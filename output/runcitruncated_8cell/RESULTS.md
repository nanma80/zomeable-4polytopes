# runcitruncated tesseract → zomeable orthographic projections

- Coxeter group: **B4**, Wythoff bitmask: **(1,1,0,1)**
- Vertices: **192**, edges: **480**
- Folder: `output/runcitruncated_8cell/`
...
- Manifest entry: `output/wythoff_sweep_manifest.json` (search `"source_polytope": "runcitruncated tesseract"`).
