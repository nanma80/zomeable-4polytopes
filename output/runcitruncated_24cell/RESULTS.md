# runcitruncated 24-cell → zomeable orthographic projections

- Coxeter group: **F4**, Wythoff bitmask: **(1,1,0,1)**
- Vertices: **576**, edges: **1440**
- Folder: `output/runcitruncated_24cell/`
...
- Manifest entry: `output/wythoff_sweep_manifest.json` (search `"source_polytope": "runcitruncated 24-cell"`).
