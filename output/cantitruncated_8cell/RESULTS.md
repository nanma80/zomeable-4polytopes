# cantitruncated tesseract → zomeable orthographic projections

- Coxeter group: **B4**, Wythoff bitmask: **(1,1,1,0)**
- Vertices: **192**, edges: **384**
- Folder: `output/cantitruncated_8cell/`
...
- Manifest entry: `output/wythoff_sweep_manifest.json` (search `"source_polytope": "cantitruncated tesseract"`).
