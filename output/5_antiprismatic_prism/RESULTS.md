...
- Folder: `output/5_antiprismatic_prism/`

**9 distinct zomeable shapes** found (rng = 2 agnostic kernel sweep).

## Shapes

| # | File | Label / direction | n_balls | Struts |
|---|------|-------------------|--------:|--------|
| 1 | `cell_first_pentagonal_antiprism.vZome` | cell_first / pentagonal_antiprism | 10 | B:20 |
| 2 | `oblique_00.vZome` | oblique | 16 | B:12  R:16  Y:8 |
| 3 | `oblique_01.vZome` | oblique | 20 | B:12  R:26  Y:12 |
| 4 | `oblique_02.vZome` | oblique | 20 | B:4  R:20  Y:26 |
| 5 | `face_first_triangle.vZome` | face_first / triangle | 20 | B:12  R:12  Y:26 |
| 6 | `oblique_03.vZome` | oblique | 20 | B:12  R:22  Y:16 |
| 7 | `face_first_square.vZome` | face_first / square | 12 | B:8  R:12  Y:4 |
| 8 | `oblique_04.vZome` | oblique | 20 | B:20  R:30 |
| 9 | `face_first_pentagon.vZome` | face_first / pentagon | 20 | B:20  R:10  Y:20 |

## Provenance

- Sweep driver: `tools/run_prismatic_sweep.py --family C --rng 2`
...
➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/5_antiprismatic_prism/RESULTS.html)** to interact with the 3D models below (the embeds only render when this file is served via GitHub Pages, not in github.com's markdown preview).
