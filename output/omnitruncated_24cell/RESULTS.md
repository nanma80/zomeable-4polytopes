# omnitruncated 24-cell → zomeable orthographic projections

- Coxeter group: **F4**, Wythoff bitmask: **(1,1,1,1)**
- Vertices: **1152**, edges: **2304**
- Folder: `output/omnitruncated_24cell/`
...
- Manifest entry: `output/wythoff_sweep_manifest.json` (search `"source_polytope": "omnitruncated 24-cell"`).
