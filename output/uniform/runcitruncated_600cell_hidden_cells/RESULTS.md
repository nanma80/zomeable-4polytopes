# runcitruncated 600-cell hidden-cell removal

These files are derived from `output/uniform/runcitruncated_600cell/` by removing
...
|---|---|---:|---:|---:|---:|
| `runcitruncated_600cell_cell_first_rhombicosidodecahedron.vZome` | unchanged (no derived file) | 3660 / 3660 | 8880 / 8880 | 0 | 0 |
