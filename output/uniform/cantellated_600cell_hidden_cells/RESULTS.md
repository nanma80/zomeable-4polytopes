...
These files are derived from `output/uniform/cantellated_600cell/` by removing
...
|---|---|---:|---:|---:|---:|
| `cantellated_600cell_cell_first_icosidodecahedron.vZome` | unchanged (no derived file) | 1860 / 1860 | 5340 / 5340 | 0 | 0 |
