...
These files are derived from `output/uniform/cantitruncated_120cell/` by removing
...
|---|---|---:|---:|---:|---:|
| `cantitruncated_120cell_cell_first_truncated_icosidodecahedron.vZome` | unchanged (no derived file) | 3660 / 3660 | 7140 / 7140 | 0 | 0 |
