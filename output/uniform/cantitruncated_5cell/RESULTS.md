...
<figure class="vzome-card">
 <vzome-viewer src="cantitruncated_5cell_cell_first_truncated_tetrahedron.vZome" progress="true" >
 </vzome-viewer>
 <figcaption>
...
<figure class="vzome-card">
 <vzome-viewer src="cantitruncated_5cell_oblique_00.vZome" progress="true" >
 </vzome-viewer>
 <figcaption>
...
<figure class="vzome-card">
 <vzome-viewer src="cantitruncated_5cell_oblique_01.vZome" progress="true" >
 </vzome-viewer>
 <figcaption>
...
<figure class="vzome-card">
 <vzome-viewer src="cantitruncated_5cell_oblique_02.vZome" progress="true" >
 </vzome-viewer>
 <figcaption>
