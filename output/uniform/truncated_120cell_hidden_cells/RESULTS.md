...
These files are derived from `output/uniform/truncated_120cell/` by removing
...
|---|---|---:|---:|---:|---:|
| `truncated_120cell_cell_first_truncated_dodecahedron.vZome` | unchanged (no derived file) | 1260 / 1260 | 2420 / 2420 | 0 | 0 |
