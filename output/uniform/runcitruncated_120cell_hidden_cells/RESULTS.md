...
These files are derived from `output/uniform/runcitruncated_120cell/` by removing
...
|---|---|---:|---:|---:|---:|
| `runcitruncated_120cell_cell_first_truncated_dodecahedron.vZome` | unchanged (no derived file) | 3660 / 3660 | 8880 / 8880 | 0 | 0 |
