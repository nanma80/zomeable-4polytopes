# truncated 600-cell → zomeable orthographic projections

- Coxeter group: **H4**, Wythoff bitmask: **(0,0,1,1)**
- Vertices: **1440**, edges: **4320**
- Folder: `output/uniform/truncated_600cell/`

**1 distinct zomeable shape** found (rng = 2 production sweep + rng = 4 inheritance-free audit):

| File | Label / direction | n_balls | fp_hash |
|------|-------------------|--------:|---------|
| `truncated_600cell_cell_first_icosahedron.vZome` | cell_first / icosahedron | 780 | `e7e32b6625` |
...
➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/uniform/truncated_600cell/RESULTS.html)** to interact with the 3D models below (the embeds only render when this file is served via GitHub Pages, not in github.com's markdown preview).
...
<figure style="width: 800px; margin: 5%">
 <vzome-viewer style="width: 100%; height: 500px" src="truncated_600cell_cell_first_icosahedron.vZome" progress="true" >
 </vzome-viewer>
