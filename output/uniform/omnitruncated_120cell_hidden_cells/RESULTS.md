...
These files are derived from `output/uniform/omnitruncated_120cell/` by removing
...
|---|---|---:|---:|---:|---:|
| `omnitruncated_120cell_cell_first_truncated_icosidodecahedron.vZome` | unchanged (no derived file) | 7200 / 7200 | 14160 / 14160 | 0 | 0 |
