...
These files are derived from `output/uniform/runcinated_120cell/` by removing
...
|---|---|---:|---:|---:|---:|
| `runcinated_120cell_cell_first_dodecahedron.vZome` | unchanged (no derived file) | 1260 / 1260 | 3600 / 3600 | 0 | 0 |
