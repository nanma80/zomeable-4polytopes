# bitruncated 24-cell → zomeable orthographic projections

- Coxeter group: **F4**, Wythoff bitmask: **(0,1,1,0)**
- Vertices: **288**, edges: **576**
- Folder: `output/bitruncated_24cell/`
...
- Manifest entry: `output/wythoff_sweep_manifest.json` (search `"source_polytope": "bitruncated 24-cell"`).
