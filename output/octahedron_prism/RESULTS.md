...
- Folder: `output/octahedron_prism/`
...
|---|------|-------------------|--------:|--------|
| 1 | `cell_first_octahedron.vZome` | cell_first / octahedron | 6 | G:12 |
| 2 | `edge_first.vZome` | edge_first | 10 | B:13  G:8 |
...
➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/octahedron_prism/RESULTS.html)** to interact with the 3D models below (the embeds only render when this file is served via GitHub Pages, not in github.com's markdown preview).
