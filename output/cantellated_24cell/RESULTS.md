# cantellated 24-cell → zomeable orthographic projections

- Coxeter group: **F4**, Wythoff bitmask: **(1,0,1,0)**
- Vertices: **288**, edges: **864**
- Folder: `output/cantellated_24cell/`
...
- Manifest entry: `output/wythoff_sweep_manifest.json` (search `"source_polytope": "cantellated 24-cell"`).
