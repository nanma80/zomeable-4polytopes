# cantitruncated 24-cell → zomeable orthographic projections

- Coxeter group: **F4**, Wythoff bitmask: **(1,1,1,0)**
- Vertices: **576**, edges: **1152**
- Folder: `output/cantitruncated_24cell/`
...
- Manifest entry: `output/wythoff_sweep_manifest.json` (search `"source_polytope": "cantitruncated 24-cell"`).
