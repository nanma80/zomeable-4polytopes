# omnitruncated tesseract → zomeable orthographic projections

- Coxeter group: **B4**, Wythoff bitmask: **(1,1,1,1)**
- Vertices: **384**, edges: **768**
- Folder: `output/omnitruncated_8cell/`
...
- Manifest entry: `output/wythoff_sweep_manifest.json` (search `"source_polytope": "omnitruncated tesseract"`).
