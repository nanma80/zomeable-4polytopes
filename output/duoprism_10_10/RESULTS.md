...
|---|------|-------------------|--------:|--------|
| 1 | `oblique_02.vZome` | oblique | 96 | B:38  R:80  Y:80 |
...
➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/duoprism_10_10/RESULTS.html)** to interact with the 3D models below (the embeds only render when this file is served via GitHub Pages, not in github.com's markdown preview).
