...
- Folder: `output/truncated_tetrahedron_prism/`
...
|---|------|-------------------|--------:|--------|
| 1 | `cell_first_truncated_tetrahedron.vZome` | cell_first / truncated_tetrahedron | 12 | G:18 |
| 2 | `face_first_square.vZome` | face_first / square | 24 | B:24  G:24 |
...
➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/truncated_tetrahedron_prism/RESULTS.html)** to interact with the 3D models below (the embeds only render when this file is served via GitHub Pages, not in github.com's markdown preview).
