# dodecahedron prism hidden-cell removal

These files are derived from `output/polyhedral_prisms/dodecahedron_prism/` by removing
...
|---|---|---:|---:|---:|---:|
| `oblique_00.vZome` | `oblique_00_front_visible.vZome` | 35 / 40 | 65 / 80 | 5 | 15 |
| `face_first_square.vZome` | unchanged (no derived file) | 24 / 24 | 42 / 42 | 0 | 0 |
| `oblique_01.vZome` | `oblique_01_front_visible.vZome` | 35 / 40 | 65 / 80 | 5 | 15 |
| `oblique_02.vZome` | `oblique_02_front_visible.vZome` | 36 / 40 | 67 / 80 | 4 | 13 |
| `cell_first_dodecahedron.vZome` | unchanged (no derived file) | 20 / 20 | 30 / 30 | 0 | 0 |
