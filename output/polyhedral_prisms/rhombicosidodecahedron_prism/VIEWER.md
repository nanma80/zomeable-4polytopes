# rhombicosidodecahedron prism — interactive 3D viewer

➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/polyhedral_prisms/rhombicosidodecahedron_prism/VIEWER.html)** to interact with the 5 models below.
...
<figure style="width: 800px; margin: 5%">
 <vzome-viewer style="width: 100%; height: 500px" src="../rhombicosidodecahedron_prism_hidden_cells/oblique_00_front_visible.vZome" progress="true" >
 </vzome-viewer>
 <figcaption style="text-align: center; font-style: italic;">
...
<figure style="width: 800px; margin: 5%">
 <vzome-viewer style="width: 100%; height: 500px" src="../rhombicosidodecahedron_prism_hidden_cells/oblique_01_front_visible.vZome" progress="true" >
 </vzome-viewer>
 <figcaption style="text-align: center; font-style: italic;">
...
<figure style="width: 800px; margin: 5%">
 <vzome-viewer style="width: 100%; height: 500px" src="../rhombicosidodecahedron_prism_hidden_cells/oblique_02_front_visible.vZome" progress="true" >
 </vzome-viewer>
 <figcaption style="text-align: center; font-style: italic;">
