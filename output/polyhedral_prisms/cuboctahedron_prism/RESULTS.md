...
- Folder: `output/polyhedral_prisms/cuboctahedron_prism/`
...
|---|------|-------------------|--------:|--------|
| 1 | `cell_first_cube.vZome` | cell_first / cube | 16 | B:16  G:16 |
| 2 | `cell_first_cuboctahedron.vZome` | cell_first / cuboctahedron | 12 | G:24 |
...
➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/polyhedral_prisms/cuboctahedron_prism/RESULTS.html)** to interact with the 3D models below (the embeds only render when this file is served via GitHub Pages, not in github.com's markdown preview).
...
<figure class="vzome-card">
 <vzome-viewer src="cell_first_cuboctahedron.vZome" progress="true" >
 </vzome-viewer>
 <figcaption>
