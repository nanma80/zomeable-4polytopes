...
➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/regular/600cell/RESULTS.html)** to interact with the 3D models below (the embeds only render when this file is served via GitHub Pages, not in github.com's markdown preview).
...
<figure class="vzome-card">
 <vzome-viewer src="600cell_H4_to_H3.vZome" progress="true" >
 </vzome-viewer>
 <figcaption>
