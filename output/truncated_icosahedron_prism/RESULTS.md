...
- Folder: `output/truncated_icosahedron_prism/`
...
|---|------|-------------------|--------:|--------|
| 1 | `cell_first_truncated_icosahedron.vZome` | cell_first / truncated_icosahedron | 60 | B:90 |
...
➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/truncated_icosahedron_prism/RESULTS.html)** to interact with the 3D models below (the embeds only render when this file is served via GitHub Pages, not in github.com's markdown preview).
