# truncated tesseract → zomeable orthographic projections

- Coxeter group: **B4**, Wythoff bitmask: **(1,1,0,0)**
- Vertices: **64**, edges: **128**
- Folder: `output/truncated_8cell/`
...
- Manifest entry: `output/wythoff_sweep_manifest.json` (search `"source_polytope": "truncated tesseract"`).
