# duoprism 5 10 hidden-cell removal

These files are derived from `output/duoprisms/duoprism_5_10/` by removing
...
|---|---|---:|---:|---:|---:|
| `face_first_decagon_00.vZome` | unchanged (no derived file) | 50 / 50 | 100 / 100 | 0 | 0 |
