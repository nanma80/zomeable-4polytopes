# {5}×{10} duoprism → zomeable orthographic projections
...
|---|------|-------------------|--------:|--------|
| 1 | `face_first_decagon_00.vZome` | face_first / decagon | 50 | B:50  R:50 |
...
➡️ **[Open this page on GitHub Pages](https://nanma80.github.io/zomeable-4polytopes/output/duoprisms/duoprism_5_10/RESULTS.html)** to interact with the 3D models below (the embeds only render when this file is served via GitHub Pages, not in github.com's markdown preview).
...
<figure class="vzome-card">
 <vzome-viewer src="face_first_decagon_00.vZome" progress="true" >
 </vzome-viewer>
 <figcaption>
