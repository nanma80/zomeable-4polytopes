# runcitruncated 16-cell → zomeable orthographic projections

- Coxeter group: **B4**, Wythoff bitmask: **(1,0,1,1)**
- Vertices: **192**, edges: **480**
- Folder: `output/runcitruncated_16cell/`
...
- Manifest entry: `output/wythoff_sweep_manifest.json` (search `"source_polytope": "runcitruncated 16-cell"`).
