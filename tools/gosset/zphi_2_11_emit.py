"""Emit vZome files for 2_11 / regular 5-orthoplex sweep hits."""
...
PUBLISH_INFO = {
    "N7_902fc4bcce76": {
        ...
        "filename": "2_11_D4_7_balls.vZome",
    },
    "N7_c2e0b30216ec": {
        "scale_label": "phi/3",
        "scale": GF(0, Fraction(1, 3)),
        "filename": "2_11_B3_7_balls.vZome",
    },
    "N9_8354fe42ad37": {
        "scale_label": "1/3",
        "scale": GF(Fraction(1, 3), 0),
        "filename": "2_11_B3_9_balls.vZome",
    },
}
...
def main():
    ...
    ap.add_argument("--json", default="ongoing_work/gosset_2_11/column_sweep_2_11_R3.json")
    ap.add_argument("--out_dir", default="output/gosset_projections/2_11")
    ...
    for sig, hit in sorted(data["hits"].items()):
        if args.raw:
            meta = {
                "scale": GF(1),
                "scale_label": "1",
                "filename": f"2_11_from_{sig}.vZome",
            }
        else:
