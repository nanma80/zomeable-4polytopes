...
A catalogue of 4-dimensional polytopes that can be projected to 3D in ways that are **physically buildable with zometool** struts (Blue / Yellow / Red / Green) and **modelled exactly in [vZome](https://vzome.com/)**.
