"""Test whether duoprism_4_10 forms an inf-family on the (a,b,0,0) kernel plane.

Hypothesis: all zomeable kernels for duoprism_4_10 have the form
...
def main():
    ...
    print(f"duoprism_4_10: V={len(V)}, E={len(edges)}")
